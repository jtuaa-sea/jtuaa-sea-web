...
const resources = {
  en: {
    translation: {
      ...
      'home.events': 'Stay tuned for our exciting upcoming events and activities',
      'home.connect': 'Connect with us and stay updated with our latest news and events.',
      'about.title': 'JTUAA Seattle',
  ...
  zh: {
    translation: {
      ...
      'home.events': '敬请关注我们即将举行的活动',
      'home.connect': '与我们保持联系，以便及时了解最新的新闻和活动',
      'about.title': '西雅图交通大学校友会',
